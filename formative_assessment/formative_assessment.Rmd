...
```{r q1}
question(
  "1) Which chunk options can be used to change the size of a figure?",
...
question(
  ...
  answer(
    "I) `FALSE`, II) `fig.align`, III) `out.width`",
    correct = TRUE,
    message = " <i class='fas fa-check'></i> Awesome! All the options were right!"
  ),
  
  answer(
    "I) `FALSE`, II) `fig.align`, III) `fig.width`",
    correct = FALSE,
    message = " I) <i class='fas fa-check'></i> `echo=FALSE` <br> II) <i class='fas fa-check'></i> ` fig.align='center'` <br> III) <i class='fas fa-exclamation'></i> To set the size of a figure relative to the size of the page, `out.width` can be used. `fig.width` can be used to set the size in inches."
  ),
  
  
  
  answer(
    "I) `TRUE`, II) `fig.cap`, III) `dpi`",
    correct = FALSE,
  ...
  answer(
    "I) `TRUE`, II) `fig.align`, III) `out.width`",
    correct = FALSE,
